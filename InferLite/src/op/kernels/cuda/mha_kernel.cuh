#ifndef INFERLITE_KERNEL_MHA_CUH
#define INFERLITE_KERNEL_MHA_CUH
...
void mha_kernel_cu(int32_t pos, int32_t head_num, int32_t layer_index, int32_t seq_len,
                   ...
                   const tensor::Tensor& value_cache_tensor, cudaStream_t stream);
}  // namespace kernel
#endif  // INFERLITE_KERNEL_MHA_CUH
